...
|---|---|---|---|
| Metacognitive Reflection Groups for Improving Student Learning Outcomes in Computing and Programming Courses and Other Courses | `reference-irbs/2024_08_09 Nelson_MOD_2_Jan_2026_FINAL.pdf` | The team's own courses (COS100/121/125/135/140/397/420/490/497/498, NMD100, HCD101); reflection-group assignments; pre/post + 8 longitudinal surveys over 4 years; courses without reflection groups as comparison | Consent-form skeleton (**Appendix P** is the most recent), Section 6 data-management framing, Section 9 compensation framing, recruitment script |
| Same protocol, Sept 2025 mod | `reference-irbs/2024_08_09 Nelson_MOD_Sept_2025_FINAL.pdf` | Adds Fall-25 courses and the $10/longitudinal-survey compensation | Career-event survey items (Appendices K, L) |
| Data-linkage modification (draft) | `IRB drafts 2026-07-23/CourseProtocol_AppendixA_DataLinkage_MARKED.docx` | Optional consent to link data across the team's related studies | Cross-study linkage language |
| Reflection Groups Outside of Classes (IRB #1, drafted, not yet submitted) | `IRB1_Protocol_ReflectionGroups_OutsideClasses_FINAL_structured.docx` | Out-of-class reflection groups; students outside coursework, alumni, professionals, community members; matching/behavior-change tool; professional comparison samples | **Interview consent form (Appendix G)** — most recent interview consent in the program; "outcomes" definition; de-named platform language; recording-deletion clause; affirmation block |

**Not accessible / not verified:** `2023_07_10 Nelson_MOD_Jan_2026_FINAL.docx` (a *different* protocol number from the 2024_08_09 series; reported to contain the approved generative-AI / video-reflection and interview consent language). Blocked by macOS file protection while in `~/Downloads`. Move it into the project folder to make it usable. Neither local reference PDF mentions generative AI, video/screen-replay reflection, or interviews — so **there is currently no verified approved AI consent language in the knowledge base.**

## 2. Activity table — NSF CAREER grant (Award 2544192)

Governing document: `grant/FINAL NSF_CAREER_25_Nelson.pdf`. One row per planned human-subjects activity. "Covered by" is the basis of the Phase-4 Pass-2 coverage check.
